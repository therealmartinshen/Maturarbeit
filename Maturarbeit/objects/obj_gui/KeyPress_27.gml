...
/// @DnDHash : 35AC971D
/// @DnDInput : 2
/// @DnDArgument : "expr" "global.isMenu"
/// @DnDArgument : "not" "1"
/// @DnDArgument : "expr_1" "isStart"
/// @DnDArgument : "not_1" "1"
if(!(global.isMenu) && !(isStart))
{
	...
	/// @DnDArgument : "layer" ""control""
	/// @DnDSaveInfo : "objectid" "8d6428ac-f7a0-474d-be2e-ddf46283eebf"
	var button1 = instance_create_layer(x + view_wport[0] / 2, y + view_hport[0] / 2 + offset, "control", obj_button);
	...
	/// @DnDArgument : "layer" ""control""
	/// @DnDSaveInfo : "objectid" "8d6428ac-f7a0-474d-be2e-ddf46283eebf"
	var button2 = instance_create_layer(x + view_wport[0] / 2, y + view_hport[0] / 2 , "control", obj_button);
	...
	/// @DnDArgument : "layer" ""control""
	/// @DnDSaveInfo : "objectid" "8d6428ac-f7a0-474d-be2e-ddf46283eebf"
	var button3 = instance_create_layer(x + view_wport[0] / 2, y + view_hport[0] / 2 - offset, "control", obj_button);
