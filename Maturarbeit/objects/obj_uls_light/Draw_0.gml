/// @description Drawing And Calculating Shadow
	...
	//Check visibility
	if (!instance_position(x, y, obj_uls_collider))
	{
		Visible = true;
	}
	else
	...
	if (Visible)
	{
		...
		//Draw Light
			//instead of simply c_white I changed it to a changeable variable, so that I am able to make useful children objects.
		if (sprite_index == -1)
		{
			draw_circle_color( (surface_get_width(light_surf)*0.5), (surface_get_height(light_surf)*0.5), light_radius, /*change!*/color, c_black, false);
		}
		else
		{
